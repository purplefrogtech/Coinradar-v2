...
# Haberler için NewsAPI anahtarı (Türkçe haberler için kullanılacak – kendi API anahtarınızı ekleyin)
...
# Kullanıcı dil tercihlerini saklamak için sözlük (user_id -> "en" veya "tr")
user_language = {}
...
# Loading bar fonksiyonu, dil desteği eklenmiş
...
# Yeni: get_market_news fonksiyonu artık dil parametresine göre farklı API'lerden haber çekiyor.
from urllib.parse import quote

async def get_market_news(lang: str) -> list:
    if lang == "tr":
        # Türkçe haberler: "ekonomi OR finans OR 'iş dünyası'" sorgusu ile haberleri çekiyoruz.
        ...
        # İngilizce haberler: CryptoCompare API kullanılıyor
        ...
        try:
            ...
            logger.error(f"Error in English market news: {e}")
            return []
